...
public class SCPListenerException extends Exception {

	private static Logger logger = Logger.getLogger(SCPListenerException.class);
	...
	public SCPListenerException(String s) {
		super(s);
	}

	public SCPListenerException(String s, Exception e) {
		super(s, e);
		logger.error(s, e);
	}

	public SCPListenerException(Exception e) {
		super(e);
		logger.error(e.getMessage(), e);
	}
	
    public static SCPListenerException exactlyOne(String[] attrs) {
        return exactlyOne(attrs, null);
    }
	
    public static SCPListenerException exactlyOne(String[] attrs, String alt) {
        ...
        return new SCPListenerException(buf.append(" is required.").toString());
    }
