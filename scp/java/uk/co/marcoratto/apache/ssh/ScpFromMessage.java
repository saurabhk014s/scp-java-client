...
public class ScpFromMessage extends AbstractSshMessage {
	...
	private static Logger logger = Logger.getLogger(ScpFromMessage.class);
    ...
    private void startRemoteCpProtocol(InputStream in,
                                       OutputStream out,
                                       File localFile)
        throws IOException, JSchException, SCPPException {
        File startFile = localFile;
        logger.debug("startFile is " + startFile);
        while (true) {
