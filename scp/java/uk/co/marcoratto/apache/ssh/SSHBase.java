...
public abstract class SSHBase {
	...
	private static Logger logger = Logger.getLogger(SSHBase.class);
     ...
     * @throws SCPPException on error
     */
    protected void init() throws SCPPException {        
    ...
    protected Session openSession() throws JSchException {
        ...
        if (!userInfo.getTrust() && knownHosts != null) {
            logger.info("Using known hosts: " + knownHosts);
