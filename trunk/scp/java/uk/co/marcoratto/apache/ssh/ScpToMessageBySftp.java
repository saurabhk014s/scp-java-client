...
public class ScpToMessageBySftp extends ScpToMessage {
	...
	private static Logger logger = Logger.getLogger(ScpToMessageBySftp.class);
    ...
    private void doMultipleTransfer() throws IOException, JSchException {
    	logger.trace("doMultipleTransfer()");
        ChannelSftp channel = openSftpChannel();
        try {
            channel.connect();
            ...
            try {
                for (Iterator i = directoryList.iterator(); i.hasNext();) {
                    ...
                    if (getVerbose()) {
                        logger.info("Sending directory " + current);
                    }
    ...
    private void sendFileToRemote(ChannelSftp channel,
        ...
        try {
            if (this.getVerbose()) {
                logger.info("Sending: " + localFile.getName() + " : " + filesize);
            }
